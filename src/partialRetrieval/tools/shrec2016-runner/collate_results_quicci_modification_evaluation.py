...
with open(os.path.join(args.outputDirectory, 'Figure_11_unwanted_bit_reductions.csv'), 'w') as outFile:
...
with open(os.path.join(args.outputDirectory, 'Figure_12_overlap_with_reference.csv'), 'w') as outFile:
